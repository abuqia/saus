...
export default function SettingsIndex({ settings, groups, fieldTypes = {} }: SettingsPageProps) {
    ...
    return (
        <AppLayout>
            ...
            <div className="flex overflow-x-auto flex-col flex-1 gap-6 p-6 h-full">
                <div className="container mx-auto py-2 space-y-6">
                    {/* Enhanced Header with Gradient */}
                    <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-primary/10 via-primary/5 to-transparent p-8 border shadow-sm">
                        ...
                        <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                            <div className="space-y-2">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h1 className="text-4xl font-bold tracking-tight bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text">Settings</h1>
                                ...
                                {isDirty && (
                                    <div className="flex items-center gap-2 text-sm text-amber-600 dark:text-amber-500 mt-3">
                                        <div className="h-2 w-2 rounded-full bg-amber-500 animate-pulse" />
                                        <span className="font-medium">{changedKeys.size} unsaved change{changedKeys.size !== 1 ? 's' : ''}</span>
                                    </div>
                                )}
                            </div>
                                ...
                                <div className="flex items-center gap-2 bg-background/50 backdrop-blur-sm rounded-lg p-1 border">
                                    <div className="relative">
                                        ...
                                        <Input
                                            ...
                                            className="pl-9 w-56 border-0 shadow-none focus-visible:ring-0"
                                        />
                                    </div>
                    ...
                    <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                        <div className="sticky top-16 z-10 bg-background/95 backdrop-blur border rounded-lg shadow-sm p-1 overflow-x-auto">
                            <TabsList className="inline-flex h-auto w-full min-w-max gap-1">
                                {Object.entries(groups).map(([key, label]) => {
                                    const count = (settings[key] || []).filter((s) => changedKeys.has(s.key)).length;
                                    const getIcon = () => {
                                        switch(key) {
                                            case 'general': return <Settings2 className="h-4 w-4" />;
                                    ...
                                    return (
                                        <TabsTrigger 
                                            key={key} 
                                            value={key}
                                            className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground whitespace-nowrap px-4 py-2 rounded-md text-sm font-medium transition-all"
                                        >
                                            <span className="flex items-center gap-2">
                                                ...
                                                {count > 0 && (
                                                    <Badge 
                                                        variant="destructive" 
                                                        className="h-5 min-w-5 px-1.5 text-xs font-semibold rounded-full"
                                                    >
                                                        {count}
                                                    </Badge>
                                                )}
                        ...
                        {Object.entries(groups).map(([groupKey, groupLabel]) => {
                            ...
                            return (
                            <TabsContent key={groupKey} value={groupKey} className="space-y-4 animate-in fade-in-50 duration-300">
