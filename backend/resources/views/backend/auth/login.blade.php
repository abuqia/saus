        ...
        <div class="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              class="form-control"
              value="{{ old('email') ?? config('app.demo_mode', false) ? 'superadmin@saus.com' : '' }}"
              required
            />
          </div>
            ...
            <div x-show="showDemoCredentials" x-transition class="px-4 py-3 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
              ...
              <div class="grid grid-cols-1 gap-2 mb-3 text-gray-500 dark:text-gray-300">
                <div class="flex items-center">
                  ...
                  <code class="px-2 py-1 text-xs font-mono bg-gray-100 dark:bg-gray-800 rounded">superadmin@saus.com</code>
                </div>
                <div class="flex items-center">
    ...
    @push('scripts')
        <script>
            document.getElementById('fill-demo-credentials').addEventListener('click', function() {
              console.log('clicked');
                document.getElementById('email').value = 'superadmin@saus.com';
