...
const GoogleLoginButton: React.FC<GoogleLoginButtonProps> = ({
    ...
    const handlePopupLogin = async () => {
        ...
        const messageHandler = (event: MessageEvent) => {
            ...
            if (event.data.type === 'GOOGLE_AUTH_SUCCESS') {
                // Success - reload page atau redirect ke dashboard
    ...
    const variantClasses = {
        ...
        outline: 'bg-transparent border-2 border-[#F53003] text-[#F53003] hover:bg-[#F53003] hover:text-white dark:border-[#FF4433] dark:text-[#FF4433] dark:hover:bg-[#FF4433]'
    };
